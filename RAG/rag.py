...
ragproxyagent = RetrieveUserProxyAgent(
    ...
    retrieve_config={
        "task": "qa",
        "docs_path": [os.path.join(os.path.abspath(""),"FluidMechanic.md")],
    },
...
#             os.path.join(os.path.abspath(""),"FluidMechanic.md")
#         ],
...
# )  # search_string is used as an extra filter for the embeddings search, in this case, we only want to search document